...
root.title("K19KP-SUSHANT-ALOK-YOGESH")
...
def board():
    tkinter.messagebox.showinfo(title=None, message="PRESS ENTER FOR START AND CROSS FOR EXIT")
    v = 0
    z = 0
...
button = Button(root, text="   ROLL   ", relief="raised", font=("Arial", 15),
                command=roll)  # call roll function evertime this button is clicked
button.place(x=790, y=120)
root.mainloop()
